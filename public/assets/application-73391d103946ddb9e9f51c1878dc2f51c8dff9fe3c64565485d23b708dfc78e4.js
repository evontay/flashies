...
(function() {
  (function($) {
    $.fn.scrollbox = function(config) {
      ...
      return this.each(function() {
        var backward, container, containerUL, forward, forwardHover, nextScrollId, pauseHover, paused, releaseStack, resetClock, scrollBackward, scrollForward, scrollingId, stackedTriggerIndex, switchCount;
        container = $(this);
        containerUL = void 0;
        scrollingId = null;
        nextScrollId = null;
        ...
        forward = void 0;
        resetClock = void 0;
        scrollForward = void 0;
        scrollBackward = void 0;
        forwardHover = void 0;
        pauseHover = void 0;
        switchCount = 0;
...
$.fn.scrollbox = function(config) {
  ...
  var defConfig = {
    ...
    listElement: 'ul',
    listItemElement:'li',
    infiniteLoop: false,     // Infinite loop or not
